...
{
	public static var psychEngineVersion:String = '4.10.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "VS Impostor: Restored v" + psychEngineVersion, 12);

...
class FlxGame extends Sprite
{
	 ...
	 */
	public function new(gameWidth = 0, gameHeight = 0, ?initialState:Class<FlxState>, zoom:Float = 1, updateFramerate = 60, drawFramerate = 60,
			skipSplash = false, startFullscreen = false)
	{
		super();
